...
const UserItem: FC<UserItemProps> = ({
    ...
    return (
        <div className="mb-4">
            ...
            <button className="border-white text-white border-2 text-sm text-black px-4 rounde-sm hover:bg-red-500" onClick={confirmDelete ? handleDeleteUser : handleConfirmDelete}> {deleteLabel} </button>
            <button className="ml-2 bg-white text-sm text-black px-4 rounde-sm hover:bg-slate-200"
